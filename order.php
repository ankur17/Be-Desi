      ...
      <div class="col-md-5 col-sm-6">
        ...
        <form id="oform" class="form-horizontal" action="includes/order-exec.php" method="POST">
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input type="text" class="form-control" placeholder="Ankur Harna" name="name" id="name">
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input type="text" class="form-control" placeholder="Delhi" name="city" id="city">
            </div>
          </div>
          <div class="form-group">
            <label for="postal_code" class="col-sm-4 control-label">PIN Code</label>
            <div class="col-sm-8">
              <input type="text" class="form-control" placeholder="110020" name="postal_code" id="postal_code">
            </div>
          </div>
